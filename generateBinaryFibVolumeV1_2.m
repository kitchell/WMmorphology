function [fiberBoolNifti, fiberDensityNifti, DiffusivityRatio,islandFlag]=generateBinaryFibVolumeV1_2(voxelResize, T1, fg, threshold, smoothBool)
% function [fiberBoolNifti, fiberDensityNifti]=generateBinaryFibVolume(voxelResize, T1, fg, threshold, smoothBool)
%
