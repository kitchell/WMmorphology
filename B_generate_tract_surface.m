function [newestnodes, newelement] = B_generate_tract_surface(fiberBoolNifti, filename)
% 
...
%
% Note, this file has a dependency: git clone git@github.com:fangq/iso2mesh.git
...
[node,elem,~,~] = v2s(uint8(BoundedVolume),[1],opt,'cgalsurf');
...
% These check th quality of the mesh.
%
% 
...
[conn, ~,~] = meshconn(newelement(:,1:3),length(newnode));
